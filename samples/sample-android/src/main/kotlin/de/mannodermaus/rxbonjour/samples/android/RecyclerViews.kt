...
abstract class RecyclerBaseAdapter<E>() : RecyclerView.Adapter<RecyclerBaseHolder<E>>() {
     ...
     */
    fun indexOf(item: E): Int = mutableItems.indices.firstOrNull { mutableItems[it] == item } ?: NO_POSITION
     ...
     */
    protected abstract fun createViewHolder(inflater: LayoutInflater, parent: ViewGroup, viewType: Int): RecyclerBaseHolder<E>
...
protected constructor(
    ...
    : RecyclerView.ViewHolder(inflater.inflate(layoutRes, parent, false)), View.OnClickListener, View.OnLongClickListener {
    ...
    init {
        ...
        itemView.setOnHoverListener { v, event -> item != null && this@RecyclerBaseHolder.onHover(v, event, item) }
    }
